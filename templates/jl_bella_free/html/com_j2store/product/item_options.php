...
<div class="options">
	...
	<div id="option-<?php echo $option['productoption_id']; ?>"
		class="option">
          ...
          <?php } ?>
          <label class="uk-form-label"><?php echo JText::_($option['option_name']); ?>:</label>&nbsp;
		<select class="uk-form-select" data-uk-form-select
	...
	<div id="option-<?php echo $option['productoption_id']; ?>"
		class="option">
          ...
          <?php endif; ?>
          <label
			for="form-s-r1 option-value-<?php echo $option_value['product_optionvalue_id']; ?>"><?php echo stripslashes($this->escape(JText::_($option_value['optionvalue_name']))); ?>
            <?php if ($option_value['product_optionvalue_price'] > 0 && $this->params->get('product_option_price', 1)) { ?>
	         	(
	         	<?php if($this->params->get('product_option_price_prefix', 1)): ?>
            		<?php echo $option_value['product_optionvalue_prefix']; ?>
