...
?>
	...
	<?php if(!$hide): ?>
			...
			<div class="j2store-minicart-button" data-uk-dropdown>
				...
				<div class="j2store-cart-item-box uk-dropdown" id="j2store_cart_item_<?php echo $module->id; ?>"  style="display:none;">
										...
										<div class="item-info">
											...
											<?php if($params->get('show_thumbimage') && !empty($thumb_image)):?>
													<span class="cart-thumb-image">
														<img class="uk-thumbnail" alt="<?php echo $item->orderitem_name; ?>" src="<?php echo JUri::root(true).'/'.$thumb_image; ?>" />
													</span>
											<?php endif;?>
