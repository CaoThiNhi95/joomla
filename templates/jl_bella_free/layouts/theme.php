    ...
    <body class="<?php echo $this['config']->get('body_classes'); ?>">
      <div id="fb-root"></div>
        ...
        <div class="uk-container uk-container-center">
          ...
          <div class="uk-float-left tm-toolbar-container"><?php echo $this['widgets']->render('toolbar-l'); ?></div>
          <?php endif; ?>
          <?php if ($this['widgets']->count('toolbar-r')) : ?>
          <div class="uk-float-right tm-toolbar-container"><?php echo $this['widgets']->render('toolbar-r'); ?></div>
          <?php endif; ?>
        </div>
        </div>
        <?php endif; ?>
        ...
        <nav class="tm-navbar uk-navbar">
            <div class="uk-container uk-container-center">
                ...
                <div class="tm-nav uk-flex uk-flex-center uk-visible-large" <?php if ($this['config']->get('navbar_sticky')) echo 'data-uk-sticky'; ?>>
