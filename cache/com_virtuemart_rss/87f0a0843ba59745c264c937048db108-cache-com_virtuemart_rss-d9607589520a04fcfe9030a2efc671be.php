<?php die("Access Denied"); ?>#x#a:2:{s:6:"result";a:5:{i:0;O:8:"stdClass":3:{s:4:"link";s:68:"http://virtuemart.net/news/490-virtuemart-3-4-prepare-for-the-future";s:5:"title";s:37:"Virtuemart 3.4 prepare for the future";s:11:"description";s:13945:"<p>This release is now ready for all our VirtueMart users.</p>
...
<ul><li>Encryption and decryption with openssl for PHP 7.2 compatibility.</li>
</ul><p><strong>Order model changes</strong></p>
<ul><li>New trigger plgVmOnUpdateSingleItem.</li>
<li>Extra variable $inputOrder to the old triggers plgVmOnUpdateOrderShipment and plgVmOnUpdateOrderPayment.</li>
</ul><p><strong>Products</strong></p>
<ul><li>New feature "maximum products", "maximum customers" per vendor and "force product pattern".</li>
...
</ul><p><strong>Customfields</strong></p>
<ul><li>Admin feature to transform a set default list of "S" customfield to another and updates the values in the products that use the transformed customfield. transformSetStringsList.</li>
...
</ul><p><strong>Currency handling</strong></p>
<ul><li>Calculation of net price rounds final price first (prevents wrong inputs) &ndash; calculatorH.</li>
...
</ul><p><strong>Image handling</strong></p>
<ul><li>Images createThumb is only executed, when file not available. Forcing of thumb creation is done by deletion.</li>
<li>Search for unused media in admin.</li>
</ul><p><strong>User switch by admin FE</strong></p>
<ul><li>New hidden config switches:</li>
...
</ul><p><strong>Orders and checkout</strong></p>
<ul><li>Cart handling a change of the quantity is included in the popup and as extra warning message in the cart.- checkForQuantities changed vmInfo from vmWarn.</li>
...
<ul><li>Added JRoute to action of the user edit form in FE.</li>
...
</ul><h1>Modifications</h1>
<ul><li>Important update for VirtueMart System plugin. It tries to load the configuration file of the installer and not the already installed one.</li>
...
<ul><li>URL of currency_converter/convertECB.php must use https now.</li>
...
<ul><li>vmstore template foundation.</li>
...
<ul><li>Moved tcpdf files to libraries/vendor/tecnickcom/ and libraries/src/Document following the new file structure of Joomla.</li>
...
</ul><h1>Work in progress</h1>
<ul><li>Vendor model another idea to handle a multicurrency store (would mean to create invoices in the user selected currency).</li>
<li>Better refund of invoices</li>
</ul>";}i:1;O:8:"stdClass":3:{s:4:"link";s:95:"http://virtuemart.net/news/489-virtuemart-3-2-14-security-release-and-enhanced-invoice-handling";s:5:"title";s:66:"VirtueMart 3.2.14 - Security Release and enhanced invoice handling";s:11:"description";s:2465:"<p>This fairly serious XSS discovered by Mattia Furlani pertained only the administration area, so most shops are not affected. Shop owners running a multi-vendor store or fearing that their employees may use this leak should update as soon as possible.</p>
...
</ul>";}i:4;O:8:"stdClass":3:{s:4:"link";s:62:"http://virtuemart.net/news/486-virtuemart-3-2-8-bugfix-release";s:5:"title";s:33:"VirtueMart 3.2.8 - Bugfix Release";s:11:"description";s:2782:"<p>Unfortunately, we were a bit too fast with our security release, having found an error in the testing phase we created another small bug while we were fixing it.</p>
